            ...
            BaseSwitch::new(self.id.clone())
                ...
                .child(
                    ...
                    SwitchTrack::new((self.id.clone(), "track"))
                        ...
                        .items_center()
                        .border(inset)
                        // Focus ring on the track itself. Upstream leaves this
                        // transparent; this fork draws the ring as a border
                        // rather than an absolute overlay (c660df8e), which is
                        // what makes a Switch visibly keyboard-reachable.
