...
// The tree's own index, served at `/component.md` — the address the published
// site uses, rather than the `/component/.md` an empty dynamic segment produces.
export const GET: APIRoute = async () => {
  const entries = await getCollection('component');
